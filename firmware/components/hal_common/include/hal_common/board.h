...
/** 显示配置 (SH8601 QSPI AMOLED 等) */
typedef struct {
    int width;              /*!< 横向分辨率 (px) */
    int height;             /*!< 纵向分辨率 (px) */
    int qspi_host;          /*!< SPI 主机编号 (spi_host_device_t 值) */
    int pclk_hz;            /*!< QSPI 像素时钟 */
    int pin_cs;             /*!< 片选 */
    int pin_sclk;           /*!< 时钟 */
    int pin_d0;             /*!< QSPI 数据 0 */
    int pin_d1;             /*!< QSPI 数据 1 */
    int pin_d2;             /*!< QSPI 数据 2 */
    int pin_d3;             /*!< QSPI 数据 3 */
