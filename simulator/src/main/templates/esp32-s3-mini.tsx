/**
 * ESP32-S3-MINI-1-N8 —— 乐鑫官方模组的真实 PCB 封装(tscircuit)
 *
 * 来源:github.com/tscircuit/motor-controller-pd-stepper
 *       imports/ESP32_S3_MINI_1_N8.tsx(pinLabels 与 footprint 逐值原样保留)
 * 改动:仅移除 cadModel 段(其 obj/step 指向 modelcdn.tscircuit.com,IDE 模板
 *       离线原则不引用 CDN;3D 视图按焊盘外接矩形绘制,不影响评估/DRC/导出)
 *
 * 65 个信号/电源引脚 + 底部 GND 散热盘阵列,共 73 个 SMT 焊盘:
 *   IO0..IO21、IO26、IO33..IO42、IO45..IO48、EN、TXD0/RXD0(UART0)、3V3、GND×32
 * 焊盘外接尺寸约 14.8×14.9mm(北侧另有 PCB 天线丝印区,约至 y+13mm)。
 *
 ...
 *   <ESP32_S3_MINI_1_N8 name="U1" layer="bottom" pcbX={0} pcbY={-2} />
 */
